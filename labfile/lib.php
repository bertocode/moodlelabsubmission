 ...
 * @author Juan José Herrero Barbosa * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
 ...
 */
function assignsubmission_labfile_pluginfile($course,
                                          $cm,
                                          context $context,
                                          $filearea,
                                          $args,
    ...
    $fullpath = "/{$context->id}/assignsubmission_labfile/$filearea/$itemid/$relativepath";
